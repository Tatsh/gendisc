local project_name = 'gendisc';
local date_released = '2024-12-05';
local version = '0.0.1';
...
local description = 'Generate disk file paths for mkisofs that fit on certain size discs.';
...
local keywords = ['iso', 'media', 'optical'];
local license = 'MIT';
  ...
  'pyproject.toml': manifestToml({
    tool: {
      poetry: {
        ...
        scripts: {
          gendisc: '%s.main:main' % module_name,
        },
      },
      commitizen: {
